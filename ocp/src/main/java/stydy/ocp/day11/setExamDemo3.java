...
public class setExamDemo3 {
	public static void main(String[] args) {
		...
		students.add(new Student(name1, Arrays.asList(exam1) ));
		students.add(new Student(name2, Arrays.asList(exam2)));
		students.add(new Student(name3, Arrays.asList(exam3)));
